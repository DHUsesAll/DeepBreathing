//
//  DHPerspectiveNavigationTransition.m
//  Test3D
//
...
#import "DHPerspectiveNavigationTransition.h"
#import "DHVector.h"
#define MAX_RADIAN M_PI/6

#define BASE_SCALE  .65

@implementation DHPerspectiveNavigationTransition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (self.usingDynamicEffect) {
        ...
        transform3d.m34 = .008;
        transform3d = CATransform3DScale(transform3d, .45, .45, .45);
        ...
        transform = [self defaultTransformNeedRotate:YES];
    }
